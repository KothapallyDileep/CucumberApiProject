...
public class Dummy_Api_GETDefinitions {
	...
	@Then("the response will return Single status {int} and id {int} and salary {int} and name {string} and age {int} and message {string}")
